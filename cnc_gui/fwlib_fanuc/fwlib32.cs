...
/*-------------*/
    ...
    {
        public ulong size;           /* ファイ?サイズ(byte) */
        public byte min;           /* タイ?スタ?プ(分) */
        public byte hour;          /* タイ?スタ?プ(?) */
        public byte day;           /* タイ?スタ?プ(日) */
        public byte month;         /* タイ?スタ?プ(?) */
        public ushort year;          /* タイ?スタ?プ(年) */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
