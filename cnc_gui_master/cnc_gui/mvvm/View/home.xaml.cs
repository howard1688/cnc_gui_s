...
namespace cnc_gui
{
    ...
    public partial class home : Page
    {
        ...
        public static DateTime SystemStart;
        public static DateTime SystemEnd;
        ...
        public home()
        {
            ...
            //dbModel.Initializeflusherhistory();
            InitializeComponent();
        ...
        private void program_start_Click(object sender, RoutedEventArgs e)
        {
            dbModel.Updateflusher_excluder_onoff("flusher_state", 0);
            dbModel.Updateflusher_excluder_onoff("excluder_state", 0);
            MessageBox.Show("程式即將啟動!\n\r請注意環沖會自動開啟!", "警告", MessageBoxButton.OK, MessageBoxImage.Warning);
            dbModel.Initializeflusherhistory();
            core.MainStart();
            //int maxid=dbModel.GetMaxId("flusher_history");
            //core.countTime = Stopwatch.StartNew();
        }

        private void program_stop_Click(object sender, RoutedEventArgs e)
        {
            core.MainStopAsync();
            MessageBox.Show($"程式已停止", "提示", MessageBoxButton.OK, MessageBoxImage.Information);
            dbModel.Updateflusher_excluder_onoff("flusher_state", 0);
            dbModel.Updateflusher_excluder_onoff("excluder_state", 0);
            dbModel.UpdateLevelResult("flusher_level_result", 1);
            dbModel.UpdateLevelResult("excluder_level_result", 1);
            core.threshold = 0;
            //core.countTime.Stop();
            //Console.WriteLine(core.countTime.ElapsedMilliseconds / 1000);
            //core.EnergyCa();
        }
    }
}
